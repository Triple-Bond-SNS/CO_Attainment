...
files.forEach(function (file) {
  ...
  if (fileExtension === ".xlsx" && file[0] != "~") {
    ...
    var totalMarks = 30;
    var sixtyPercent = 0.6 *  totalMarks ;
    data1[0][8]="Results";
    data1[1][8]="Total Marks of CO"
    data1[2][8]="60% of CO marks"
    data1[3][8]="Total Students in class"
    data1[4][8]="No of students scored more than target value ie (60%):"
    data1[5][8]="% of students securing more than target value(60)"
    data1[1][7] = totalMarks;
    data1[2][7] = sixtyPercent;
    data1[3][7] = number;
    data1[4][7] = count;
    data1[5][7] = (count/number)*100;
